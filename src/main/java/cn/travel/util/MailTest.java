...
public class MailTest {
	...
	public void testJavaMail() throws Exception{
		...
		//设置发送者 密码:520520cjc
		Address fromAddress = new InternetAddress("bluecats2020@163.com");//邮件地址
		message.setFrom(fromAddress);//设置发送的邮件地址
		//设置接收者
		Address toAddress = new InternetAddress("bluecats2010@163.com");//邮件地址
		...
		transport.connect("smtp.163.com","bluecats2020","520520cjc");
		//火箭点火，发送
